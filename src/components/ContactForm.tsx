...
const CONTACT_EMAIL = 'info@artstation.uz'
...
// использования прямо в клиентском коде. На момент написания привязан к
// старой почте artstation.uz@gmail.com (не info@artstation.uz, указанной
// на сайте) — при желании перевыпустить на новый адрес: https://web3forms.com
