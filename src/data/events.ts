...
export const fullEvents: EventFull[] = [
  ...
  },
  {
    ...
    // вместо конкретного числа показываем месяц. endDate поставлен на день
    // перед открытием «Слияний» (18.09) как разумная верхняя граница:
    // это последний этап перед выставкой, поэтому событие остаётся
    // «идёт сейчас» вплоть до её открытия. Итоговая выставка, на которую
    // эти воркшопы работали, теперь известна и датирована — см.
  ...
  {
    // Открытый набор (open call), объявленный Art Station в соцсетях
    // 2026-09-25. Даты ниже — даты самой лаборатории (20–30.10.2026);
    // дедлайн подачи заявки (08.10.2026) указан в тексте описания.
    id: 'lab_margilan_samarkand_bukhara_2026',
    type: 'workshop',
    hasFullContent: true,
    startDate: '2026-10-20',
    endDate: '2026-10-30',
    place: 'Маргилан, Самарканд, Бухара',
    coverImage: 'images/events/lab_margilan_samarkand_bukhara_2026/cover.webp',
    video: 'images/events/lab_margilan_samarkand_bukhara_2026/video.mp4',
    gallery: [],
    partnerIds: [],
    artistIds: [],
    ...
    description: {
      ru: 'Art Station объявляет приём заявок на участие в передвижной арт-лаборатории.\n\nМы приглашаем мастеров, работающих с традиционными практиками, и художников-дизайнеров, заинтересованных в работе с ремесленными техниками и материалами, принять участие в творческом эксперименте.\n\nРаботая парами, участники будут исследовать возможности взаимодействия дизайна и традиционных ремёсел в актуальном искусстве. Через творчество, нестандартные решения и коммуникацию они создадут уникальные объекты, выходящие за рамки привычного.\n\nСроки проведения: 20–30 октября 2026 года. Маршрут: Маргилан, Самарканд, Бухара. Срок подачи заявки — до 8 октября 2026 года.\n\nУчаствовать могут только граждане Узбекистана.',
      uz: 'Art Station ko‘chma san’at laboratoriyasida ishtirok etish uchun arizalar qabulini e’lon qiladi.\n\nBiz an’anaviy amaliyotlar bilan ishlaydigan ustalarni va hunarmandchilik texnikalari va materiallari bilan ishlashga qiziqqan rassom-dizaynerlarni ijodiy tajribada ishtirok etishga taklif qilamiz.\n\nJuftliklarda ishlab, ishtirokchilar dizayn va an’anaviy hunarmandchilikning zamonaviy san’atdagi o‘zaro ta’sir imkoniyatlarini o‘rganadilar. Ijod, nostandart yechimlar va muloqot orqali ular odatiy chegaralardan chetga chiqadigan noyob obyektlar yaratadilar.\n\nO‘tkazilish muddati: 2026-yil 20–30-oktabr. Marshrut: Margilon, Samarqand, Buxoro. Ariza topshirish muddati — 2026-yil 8-oktabrgacha.\n\nFaqat O‘zbekiston fuqarolari ishtirok etishi mumkin.',
      en: 'Art Station announces an open call for a traveling art laboratory.\n\nWe invite masters working with traditional practices, as well as artist-designers interested in craft techniques and materials, to take part in a creative experiment.\n\nWorking in pairs, participants will explore how design and traditional crafts can interact within contemporary art. Through creativity, unconventional solutions, and communication, they will create unique objects that go beyond the ordinary.\n\nDates: 20–30 October 2026. Route: Margilan, Samarkand, Bukhara. Application deadline: 8 October 2026.\n\nOpen only to citizens of Uzbekistan.',
    },
  },
]
